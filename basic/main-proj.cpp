...
int main(){
    ...
    hitable *list[3];
    list[0] = new sphere(glm::vec3(1.2,-0.0,-1.5), 0.5, 
		         new lambertian(glm::vec3(0.1, 0.2, 0.5)));

    list[1] = new triangle(glm::vec3( 1.4, -0.8, -2.0), 
		           glm::vec3(-0.2, -1.4, -1.1),
			   glm::vec3( 1.2, -1.2, -1.1), 
		           new lambertian(glm::vec3(0.9, 0.4, 0.3)));

    list[2] = new plane(glm::vec3( 0.8, -1.8, -12.0), 
		        glm::vec3(-0.2, -2.4, -11.5),
			glm::vec3( 1.2, -2.2, -11.5), 
		        new lambertian(glm::vec3(0.0, 0.0, 0.0)));
