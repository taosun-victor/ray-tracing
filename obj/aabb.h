...
/*
a. modified from https://github.com/petershirley/raytracingthenextweek/blob/master/aabb.h
b. using glm/glm::vec3 to deal with 3-d vectors
c. using C++ standard fmax(), fmin() functions
*/
